define("@scom/scom-uniswap-v3-contract", ["require", "exports", "@scom/scom-uniswap-v3-core", "@scom/scom-uniswap-v3-periphery", "@scom/scom-uniswap-swap-router-contracts", "@scom/scom-uniswap-v3-core", "@scom/scom-uniswap-v3-periphery", "@scom/scom-uniswap-swap-router-contracts", "@ijstech/eth-wallet"], function (require, exports, scom_uniswap_v3_core_1, scom_uniswap_v3_periphery_1, scom_uniswap_swap_router_contracts_1, scom_uniswap_v3_core_2, scom_uniswap_v3_periphery_2, scom_uniswap_swap_router_contracts_2, eth_wallet_1) {
    "use strict";
    ...
    Object.defineProperty(exports, "CoreContracts", { enumerable: true, get: function () { return scom_uniswap_v3_core_2.Contracts; } });
    Object.defineProperty(exports, "PeripheryContracts", { enumerable: true, get: function () { return scom_uniswap_v3_periphery_2.Contracts; } });
    Object.defineProperty(exports, "SwapRouterContracts", { enumerable: true, get: function () { return scom_uniswap_swap_router_contracts_2.Contracts; } });
    ;
    ;
    var progressHandler;
    ...
    async function deploy(wallet, options, onProgress) {
        ...
        let factory = new scom_uniswap_v3_core_1.Contracts.UniswapV3Factory(wallet);
        await factory.deploy();
        onProgress(`factory: ${factory.address}`);
        onProgress('2/9 Deploy TickLens contract');
        let tickLens = new scom_uniswap_v3_periphery_1.Contracts.TickLens(wallet);
        await tickLens.deploy();
        onProgress(`tickLens: ${tickLens.address}`);
        onProgress('3/9 Deploy Quoter contract');
        let quoter = new scom_uniswap_v3_periphery_1.Contracts.Quoter(wallet);
        ...
        let router = new scom_uniswap_v3_periphery_1.Contracts.SwapRouter(wallet);
        ...
        let nftDesc = new scom_uniswap_v3_periphery_1.Contracts.NFTDescriptor(wallet);
        await nftDesc.deploy();
        onProgress(`nftDesc: ${nftDesc.address}`);
        onProgress('6/9 Deploy NonfungibleTokenPositionDescriptor contract');
        let nftPosDesc = new scom_uniswap_v3_periphery_1.Contracts.NonfungibleTokenPositionDescriptor(wallet);
        ...
        let nftPosMngr = new scom_uniswap_v3_periphery_1.Contracts.NonfungiblePositionManager(wallet);
        ...
        let quoterV2 = new scom_uniswap_v3_periphery_1.Contracts.QuoterV2(wallet);
        ...
        let router02 = new scom_uniswap_swap_router_contracts_1.Contracts.SwapRouter02(wallet);
    ...
    function fromDeployResult(wallet, result) {
        return {
            factory: new scom_uniswap_v3_core_1.Contracts.UniswapV3Factory(wallet, result.factory),
            tickLens: new scom_uniswap_v3_periphery_1.Contracts.TickLens(wallet, result.tickLens),
            quoter: new scom_uniswap_v3_periphery_1.Contracts.Quoter(wallet, result.quoter),
            router: new scom_uniswap_v3_periphery_1.Contracts.SwapRouter(wallet, result.router),
            nftDesc: new scom_uniswap_v3_periphery_1.Contracts.NFTDescriptor(wallet, result.nftDesc),
            nftPosDesc: new scom_uniswap_v3_periphery_1.Contracts.NonfungibleTokenPositionDescriptor(wallet, result.nftPosDesc),
            nftPosMngr: new scom_uniswap_v3_periphery_1.Contracts.NonfungiblePositionManager(wallet, result.nftPosMngr),
            quoterV2: new scom_uniswap_v3_periphery_1.Contracts.QuoterV2(wallet, result.quoterV2),
            router02: new scom_uniswap_swap_router_contracts_1.Contracts.SwapRouter02(wallet, result.router02)
        };
    }
    ...
    const getExactAmountOutRoutes = async (param) => {
        ...
        const quoter = new scom_uniswap_v3_periphery_1.Contracts.Quoter(wallet, quoterAddress);
        // Single hop
    ...
    exports.default = {
        CoreContracts: scom_uniswap_v3_core_1.Contracts,
        PeripheryContracts: scom_uniswap_v3_periphery_1.Contracts,
        SwapRouterContracts: scom_uniswap_swap_router_contracts_1.Contracts,
